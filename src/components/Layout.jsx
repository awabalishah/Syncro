                ...
                <div className="container mx-auto px-6 h-full flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
                        ...
                        <a
                            ...
                            className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10 text-sm font-bold transition-all"
                        >
                    ...
                    >
                        <nav className="flex flex-col gap-6 text-lg font-medium text-slate-300">
                            ...
                            <a
                                ...
                                className="bg-white/5 border border-white/10 text-white hover:bg-white/10 py-3 rounded-lg w-full font-bold text-center transition-all"
                            >
                                Join Discord
                            </a>
                        </nav>
