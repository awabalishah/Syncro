            ...
            <header className="sticky top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
                <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                        ...
                        <a
                            href="https://discord.gg/syncro" // Placeholder or actual link if known
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition-colors text-xs font-semibold"
                        >
                        ...
                        <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full transition-all shadow-lg shadow-blue-600/20">
                            Get Started
                        </button>
                    </nav>
                ...
                {isMenuOpen && (
                    ...
                    >
                        <nav className="flex flex-col gap-6 text-lg font-medium text-slate-600">
                            ...
                            <button className="bg-blue-600 text-white py-3 rounded-lg w-full shadow-lg shadow-blue-600/20">
                                Get Started
                            </button>
                        </nav>
                    </motion.div>
