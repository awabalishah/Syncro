...
function StickyBanner() {
    return (
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 text-white py-2 px-4 text-center text-sm font-medium border-b border-white/10 relative z-50">
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-950">
            ...
            <header
                ...
                style={!isScrolled && isHomePage ? { top: '3rem' } : {}}
            >
                <div className="container mx-auto px-6 h-full flex items-center justify-between">
                    <Link to="/" className="text-2xl font-bold font-manrope tracking-tight text-white">
